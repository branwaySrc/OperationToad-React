const Nav = () => {
  return (
    <header className='text-sm font-pretendardB'>
      <nav className='flex flex-col items-center justify-center'>
        <div className='w-screen max-w-screen-xl'>
        <div className="flex justify-between p-3 items-center">
          <div className="px-16 py-7 bg-center  bg-contain bg-no-repeat  bg-[url('./assets/img/toad_logo.svg')]"></div>
      ...
      <div className='flex bg-gray200 justify-center p-3'>
        <p className='text-sm'>

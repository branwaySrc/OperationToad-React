    ...
    <main className='bg-gray300 h-[1800px] z-0' >
      ...
      <section>
        <InstagramPost
          ...
          text='시발년아'
          likes='10'
          profile={["./content/My.svg"]}
          post={["./content/insta1.gif"]}  
        >
        </InstagramPost>
      </section>  
    </main>
